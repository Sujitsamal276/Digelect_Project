    ...
    return (
        ...
        <div className="footer-content">
            <div className="col">
                ...
                <div className="text">
                  ...
                  aperiam, eaque ipsa quae ab ille inventore veritatis et
            ...
            <div className="c-item">
              <FaLocationArrow />
              <div className="text">
                Layaloram Rd, Punnamada, Kottankulangara, Alappuzha,
                Kerala, 688006
                </div>  
            </div>
            <div className="c-item">
        ...
        <div className="bottom-bar">
            <div className="bottom-bar-content">
                <span className="text">
                    JSDEVSTORE 2022 CREATED BY JS DEV. PREMIUM E-COMMERERCE
                    SOLUTIONS.
                </span>
                <img src={Payment} />
            </div>
